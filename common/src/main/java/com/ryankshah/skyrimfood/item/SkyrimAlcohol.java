package com.ryankshah.skyrimfood.item;
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entityLiving) {
        ...
        if (!worldIn.isClientSide()) {
            if(playerEntity instanceof ServerPlayer) {
                ...
                serverPlayerEntity.addEffect(new MobEffectInstance(MobEffects.NAUSEA, worldIn.random.nextIntBetweenInclusive(4 * 20, 10 * 20), worldIn.random.nextIntBetweenInclusive(2, 20), true, true, true));
